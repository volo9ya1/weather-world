...
const i18n = {
  ru: {
    ...
    uvStatuses: { low: "Низкий", moderate: "Умеренный", high: "Высокий 🧴", danger: "Опасный 🕶️" },
    moonPhases: [
  ...
  en: {
    ...
    uvStatuses: { low: "Low", moderate: "Moderate", high: "High 🧴", danger: "Danger 🕶️" },
    moonPhases: [
  ...
  uz: {
    ...
    uvStatuses: { low: "Past", moderate: "O'rtacha", high: "Yuqori 🧴", danger: "Xavfli 🕶️" },
    moonPhases: [
